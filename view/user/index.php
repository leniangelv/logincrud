...
<head>
    ...
    <script>
        function validarform() {
            ...
            if (x == "") {
                alert("El campo de Numero de Inscripcion no puede ir vacio");
                return false;
            }
        }
    </script>
...
<body>
    <?php
        echo '<a class="logout" href="../../controller/cerrarSesion.php">Cerrar Sesion</a>'
    ?>
    <div class="container">
                ...
                <div class="col-md-4 mx-auto">
                    <div class="card card-body">
                        <form method="post" name="form" onsubmit="return validarform()" action="create.php">
                            ...
                            <div class="form-group">
                                <input type="text" name="ci" class="form-control" placeholder="Ingresar Cedula de Identidad"
                                    autocomplete="off" required>
                            </div>
                            <div class="form-group">
                                <input type="text" name="fn" class="form-control" placeholder="Ingresar Fecha de Nacimiento"
                                    autocomplete="off" required>
                            </div>
                            <div class="form-group">
                                <input type="text" name="estado" class="form-control" placeholder="Ingresar Estado de la Inscripcion"
                                    autocomplete="off" required>
                            </div>
                ...
                <div class="col-md-8 mx-auto">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            ?>
                            <tr>
                                <td><?php echo $row['cod_doctor'] ?></td>
                                <td><?php echo $row['nombre'] ?></td>
                                <td><?php echo $row['ci'] ?></td>
                                <td><?php echo $row['fn'] ?></td>
                                <td><?php echo $row['estado'] ?></td>
                                <td>
                                    <a href="update.php?cod_doctor=<?php echo $row['cod_doctor']?>" class="btn btn-secondary">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    <a href="delete.php?cod_doctor=<?php echo $row['cod_doctor']?>" class="btn btn-danger">
